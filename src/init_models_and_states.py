...
from src.env_utils import make_gym_env, make_custom_gym_env
...
def init_models_and_states(flags, target_map):
    ...
    env = make_custom_gym_env(flags.env.split(',')[0], target_map)
