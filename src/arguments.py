...
# General settings, MiniGrid-CustomDoorKey-8x8-v0, MiniGrid-DoorKey-6x6-v0
...
parser.add_argument('--savedir', default='17November_logs',
                    help='Root dir where experiment data will be saved.')
parser.add_argument('--num_actors', default=1, type=int, metavar='N',
                    help='Number of actors.')
parser.add_argument('--total_frames', default=5000000, type=int, metavar='T',
                    help='Total environment frames to train for.')
parser.add_argument('--eval_freq', default=10000, type=int, metavar='T',
...
# Training models
parser.add_argument('--model', default='cbet',
