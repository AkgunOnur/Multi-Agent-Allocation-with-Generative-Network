...
class CustomMiniGridEnv(gym.Env):
    ...
    def __init__(
        ...
        self.actions = CustomMiniGridEnv.Actions
        ...
        # print ("Minigrid Shape: ", self.width, "-", self.height)
    ...
    def step(self, action):
        ...
        # state_action = list(self.agent_pos)
        # state_action.append(action)

        # if state_action not in self.state_action_list:
        ...
        # print ("liste: ", self.state_action_list)
    ...
    def gen_obs(self):
        ...
        # print ("Minigrid: Obs: ", obs['image'].shape)
    ...
    def get_observation(self):
        ...
        # obs_map = np.zeros((self.target_map_lim, self.target_map_lim, 3))
        # grid, vis_mask = self.gen_obs_grid()
        # full_grid = grid.encode()
