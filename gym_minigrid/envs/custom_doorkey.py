...
class CustomDoorKeyEnv(CustomMiniGridEnv):
    ...
    def __init__(self, config: dict, frame_file = "frames"): #, size=8, seed=None, env_map=None, custom=False, visualization=False):
        self.seed_no = config["seed"]
        self.custom = config["custom"]
        self.env_map = config["env_map"]
        self.visualization = config["visualization"]
        # self.target_map_lim = config["target_map_lim"]
        super().__init__(
