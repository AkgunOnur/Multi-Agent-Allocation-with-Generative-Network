...
class Logger:
    ...
    def __init__(self, config: ExperimentConfig, train_iter:int, map_index:int):
        ...
        if self._use_neptune:
            ...
            self._neptune_run = neptune.init(project=user_name + "/" + project_name,
                                api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiIxZjUyNzMxZi1iNTIyLTQzMDEtYjdhMC00ZTdjNTJjZDUwODAifQ==")
    ...
    def _create_dirs(self, env_name, seed, save_models, train_iter, map_index):
        # create directories
        save_dir = "./runs/" + "%s_%s_" % ("AGAC", env_name)
        save_dir += "map_" + str(map_index) + "_iter_" + str(train_iter)
